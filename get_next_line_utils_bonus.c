...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/23 17:16:58 by jede-ara          #+#    #+#             */
/*   Updated: 2022/11/24 17:41:30 by jede-ara         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strjoin(char *s, char *buff)
{
	...
	if (!s || !buff)
		return (NULL);
	s2 = malloc(sizeof(char) * ((ft_strlen(s) + ft_strlen(buff)) + 1));
	if (s2 == NULL)
		return (NULL);
	i = -1;
	j = 0;
	...
	while (buff[j] != '\0')
		s2[i++] = buff[j++];
	s2[ft_strlen(s) + ft_strlen(buff)] = '\0';
	free(s);
	return (s2);
}
...
char	*ft_new_line(char *s)
{
	...
	src = (char *)malloc((ft_strlen(s) - i + 1) * sizeof(char));
	if (!src)
		return (NULL);
	i++;
	j = 0;
